...
namespace Algorithms.Tests.Other
{
    public static class KochSnowflakeTest
    {
        ...
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Algorithms.Other.KochSnowflake.GetBitmap(null, bitmapWidth:-200));
        }
        
        [Test]
        public static void BitmapHeightIsZeroOrNegative_ThrowsArgumentOutOfRangeException()
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => Algorithms.Other.KochSnowflake.GetBitmap(null, bitmapHeight:0));
        }
