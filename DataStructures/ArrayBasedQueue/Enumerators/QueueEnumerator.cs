...
namespace DataStructures.ArrayBasedQueue.Enumerators
{
    /// <summary>
    ...
    public sealed class QueueEnumerator<T> : IEnumerator<T>
    {
        ...
        {
            this.position = incrementer(this.position);
            return condition(this.position, this.rear);
        }
