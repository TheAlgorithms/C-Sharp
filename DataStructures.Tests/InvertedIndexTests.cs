...
namespace DataStructures.Tests
{
    ...
    {
        [Test]
        public void Or_GetSourcesWithAtLeastOne_ReturnAllSources()
        {
            ...
            var or = index.Or("star", "sparkling");
        ...
        [Test]
        public void And_GetSourcesWithAllInside_ReturnFirstSource()
        {
            var index = new InvertedIndex();
            var source1 = "one star is sparkling bright";
            var source2 = "two stars are sparkling even brighter";
            ...
            var and = index.And("star", "sparkling");
